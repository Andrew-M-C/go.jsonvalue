...
// Option is used for additional options when marshaling. Can be either a options{}
// (not pointer to it) or other options generated by jsonvalue.OptXxxx() functions.
//
// Option 表示用于序列化的额外选项。可以是一个 options{} 结构体值（而不是它的指针），或者是使用
...
func (opt *options) combineOptionsFrom(opts []Option) {
	for _, o := range opts {
		if o != nil {
			o(opt)
		}
...
// OptOmitNull configures OmitNull field in options{}, identifying whether null values
// should be omitted when marshaling.
//
// OptOmitNull 配置 options{} 中的 OmitNull 字段，表示是否忽略 null 值。
...
func OptIgnoreOmitempty() Option {
	return func(o *options) {
		o.ignoreJsonOmitempty = true
	}
}

// ==== MarshalLessFunc ===

// OptKeySequenceWithLessFunc configures MarshalLessFunc field in options{}, which defines
// key sequence when marshaling.
//
// OptKeySequenceWithLessFunc 配置 options{} 中的 MarshalLessFunc 字段，配置序列化时的键顺序。
func OptKeySequenceWithLessFunc(f MarshalLessFunc) Option {
	return func(o *options) {
		if f != nil {
			o.MarshalLessFunc = f
			o.MarshalKeySequence = nil
			o.keySequence = nil
			o.marshalBySetSequence = false
		}
	}
}

// OptDefaultStringSequence configures MarshalLessFunc field in options{} as jsonvalue.DefaultStringSequence,
// which is dictionary sequence.
//
// OptDefaultStringSequence 配置 options{} 中的 MarshalLessFunc 字段为 jsonvalue.DefaultStringSequence，也就是字典序。
func OptDefaultStringSequence() Option {
	return OptKeySequenceWithLessFunc(DefaultStringSequence)
}

// ==== MarshalKeySequence ====

// OptKeySequence configures MarshalKeySequence field in options{}.
//
// OptKeySequence 配置 options{} 中的 MarshalKeySequence 字段。
func OptKeySequence(seq []string) Option {
	return func(o *options) {
		o.MarshalLessFunc = nil
		o.MarshalKeySequence = seq
		o.keySequence = nil
		o.marshalBySetSequence = false
	}
}
...
func OptFloatNaNToFloat(f float64) Option {
	return func(o *options) {
		o.FloatNaNHandleType = FloatNaNConvertToFloat
		o.FloatNaNToFloat = f
	}
}
...
func OptFloatNaNToNull() Option {
	return func(o *options) {
		o.FloatNaNHandleType = FloatNaNNull
	}
}
...
func OptFloatNaNToStringNaN() Option {
	return OptFloatNaNToString("NaN")
}
...
func OptFloatNaNToString(s string) Option {
	return func(o *options) {
		...
		o.FloatNaNHandleType = FloatNaNConvertToString
		o.FloatNaNToString = s
	}
}
...
func OptFloatInfToFloat(f float64) Option {
	return func(o *options) {
		o.FloatInfHandleType = FloatInfConvertToFloat
		o.FloatInfToFloat = f
	}
}
...
func OptFloatInfToNull() Option {
	return func(o *options) {
		o.FloatInfHandleType = FloatInfNull
	}
}
...
func OptFloatInfToStringInf() Option {
	return OptFloatInfToString("+Inf", "-Inf")
}
...
func OptFloatInfToString(positiveInf, negativeInf string) Option {
	return func(opt *options) {
		...
		opt.FloatInfPositiveToString = positiveInf
		opt.FloatInfNegativeToString = negativeInf
	}
}
...
func (o *options) parseEscapingFuncs() {
...
func OptIndent(prefix, indent string) Option {
	return func(opt *options) {
		...
		opt.indent.prefix = prefix
		opt.indent.indent = indent
	}
}
